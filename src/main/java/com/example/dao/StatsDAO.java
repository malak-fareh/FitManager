...
public class StatsDAO {
    ...
    /**
     * CORRECTION : statut 'actif' passé en paramètre préparé
     * au lieu d'être hardcodé dans la chaîne SQL.
     */
    ...
    /**
     * NOTE : le nom de table `local` est un mot réservé MySQL.
     * Les backticks sont conservés. Si possible, renommez la table
     * en `salle` ou `branche` pour éviter tout conflit futur.
     */
